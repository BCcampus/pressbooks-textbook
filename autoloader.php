...
class Autoloader {
	...
	protected function loadMappedFile( $prefix, $relative_class ) {
		...
		foreach ( $this->prefixes[ $prefix ] as $base_dir ) {
			...
			// class is located in a directory in the base directory
			...
			} else { // class is located at the base directory
				$file = 'class-' . str_replace( '_', '-', $relative_class ) . '.php';
			}

			$file = $base_dir . strtolower( $file );
