...
function bccl_get_license( $slug ) {
	...
	$licenses = array(
		...
		'cc0'   => array(         // slug (unique for each license)
			...
			'extended_text' => __( 'To the extent possible under law, %1$s has waived all copyright and related or neighboring rights to %1$s.', 'cc-configurator' ), // expects args: 1:creator link 2:work link
			'additional_perms_text' => '',
		),
