...
tinymce.PluginManager.add( 'AtD', function( editor ) {
	...
	function getLang( key, defaultStr ) {
		return ( window.TSpell_l10n_r0ar && window.TSpell_l10n_r0ar[key] ) || defaultStr;
	}
	...
	editor.on( 'init', function() {
		...
		editor.addCommand( 'mceWritingImprovementTool', function( callback ) {
			...
			if ( typeof window.TSpell_proofread_click_count !== 'undefined' ) {
				window.TSpell_proofread_click_count++;
			}
